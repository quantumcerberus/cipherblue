...
cp "$MODULE_DIRECTORY/cipherblue-signing/policy.json" $CONTAINER_DIR/policy.json
cp "$MODULE_DIRECTORY/cipherblue-signing/policy.json" $ETC_CONTAINER_DIR/policy.json
